...
export const toolRegistry: Tool[] = [
  ...
  { id: 'air-quality-checker', name: 'Air Quality Checker', slug: 'air-quality', description: 'Real-time air quality index for Philippine cities', category: 'daily', keywords: ['air', 'quality', 'aqi', 'pollution', 'pm2.5', 'hangin', 'kalidad'], icon: 'Wind', status: 'active', path: '/tools/air-quality', requiresApi: false },
  { id: 'traffic-monitor', name: 'Metro Manila Traffic Monitor', slug: 'traffic-monitor', description: 'Expressway tolls, commute costs, and traffic schedule', category: 'daily', keywords: ['traffic', 'commute', 'nlex', 'slex', 'edsa', 'mrt', 'expressway', 'toll', 'biyahe'], icon: 'MapPin', status: 'active', path: '/tools/traffic-monitor', requiresApi: false },
